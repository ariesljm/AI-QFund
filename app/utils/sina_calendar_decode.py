"""新浪交易日历解码 JS（复用 akshare 的 hk_js_decode，MIT License）。

akshare 的 tool_trade_date_hist_sina 用该混淆解码函数还原新浪 klc_td_sh.txt
的压缩交易日数据；此处原样内置以替代整个 akshare 依赖链。
"""

DECODE_JS = """function d(t) {
